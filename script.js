...
function displayRandomNumbers() {
    ...
    if (outputDiv1 && outputDiv2 && outputDiv3 && biggestDiv && letterDiv) 
    { 
        ...
        timeBreakdownDiv.textContent = "The hr-min breakdown of" + (numbers.num2 * numbers.num3) +"mins is:" + hours + "hours and" + minutes + "minutes";
    } 
    else 
    {
